...
HudStatusText::HudStatusText(std::string labelObjectId, std::string statusObjectId, std::string statusValueId, float labelPadding, Scene* parentScene)
{
	...
	m_label = parentScene->createGameObject(labelObjectId, -50.0f, -50.0f, 0.0f, parentScene, GameLayer::GUI_1);
	...
	m_statusObject = parentScene->createGameObject(statusObjectId, -50.0f, -50.0f, 0.0f, parentScene, GameLayer::GUI_1);
